...
desc:"End-to-end event production from concept to stage execution."
},
{
title:"Brand Activations",
desc:"Experiential brand activations designed to engage audiences."
},
{
title:"Exhibitions",
desc:"Large-scale exhibition planning and pavilion design."
},
{
title:"Corporate Events",
desc:"Corporate launches, summits and annual conferences."
},
{
title:"Experiential Marketing",
desc:"Immersive brand experiences that connect with consumers."
},
{
title:"Hybrid Events",
desc:"Physical + digital broadcast experiences for modern audiences."
}
]
...
<section className="container-custom pt-32 pb-16">

<h1 className="text-4xl md:text-6xl font-bold text-center">
Two Decades of Captured Experiences
</h1>

<p className="text-center text-muted-foreground mt-4 max-w-2xl mx-auto">
India's leading experiential events agency — photo archive spanning
20+ years and 50+ industries.
</p>
...
<div className="grid grid-cols-2 md:grid-cols-6 gap-6 text-center text-muted-foreground">

{clients.map((c,i)=>(
<div key={i} className="font-medium opacity-70">
{c}
</div>
))}
...
<DualCtaSection
sellers={{
title:"Plan Your Event With ICE",
