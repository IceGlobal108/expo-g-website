...
const Gallery = () => {
  const [items, setItems] = useState(galleryItems.slice(0, ITEMS_PER_PAGE));
  const [page, setPage] = useState(1);
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 text-center">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto">
          Explore our professional event photography portfolio across
          conferences, expos, launches and corporate events.
        </p>
      </section>

      {/* Search */}
      <section className="pb-10">
        <div className="container-custom max-w-xl mx-auto relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-3 border rounded-xl bg-background"
          />
        </div>
      </section>
      ...
      <section className="py-20 bg-muted/30 text-center">
        <h3 className="text-2xl font-semibold mb-4">
          Need High-Resolution Samples?
        </h3>

        <p className="text-muted-foreground mb-6">
          Request access to our professional photo sample pack.
        </p>
