...
const contactCards: ContactCard[] = [
  { icon: "mail", title: "Email", value: "hello@ICEglobal.com", hint: "We reply within one business day" },
  { icon: "phone", title: "Phone", value: "+91 98765 43210", hint: "Mon–Fri 9:30 AM – 6:30 PM IST" },
  { icon: "map", title: "Head Office", value: "Mumbai, India", hint: "Visit by appointment" },
  { icon: "clock", title: "Turnaround", value: "2–3 days for proposals", hint: "Faster for partners" },
];
...
const defaultFields: DynamicField[] = [
  ...
  { id: "role", label: "Role / Designation", type: "text" },
  {
    ...
    label: "Event Type",
    type: "select",
    options: ["Product Launch", "Trade Show Booth", "Corporate Event", "Conference"]
  },
  {
    id: "budget",
    label: "Budget Range",
  ...
  <main className="min-h-screen bg-background">
    ...
    <section className="pt-36 pb-16 container-custom">
      ...
      <p className="text-muted-foreground max-w-xl">
        Tell us what you want to launch or showcase. We'll create a tailored experience.
      </p>
    ...
    <section className="container-custom grid lg:grid-cols-5 gap-12">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div className="pt-4 space-y-2">
          ...
          <a href="https://wa.me/919876543210" className="text-primary block">
            WhatsApp Business
          </a>

          <a href="https://linkedin.com/company/iceglobalexpo" className="text-primary block">
        ...
        {!galleryMode && fields.map(field=>{
          ...
          <div key={field.id}>
            ...
            {field.type==="textarea" ? (
              ...
              <select className="w-full border rounded p-2" {...common}>
