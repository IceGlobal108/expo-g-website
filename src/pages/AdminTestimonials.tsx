...
const AdminTestimonials = () => {
      ...
      if (pendingDeletes.length) {
        await fetch(`${base}/media/delete`, {
          ...
          body: JSON.stringify({
            ...
            reason: "testimonial-image-replace",
          }),
        });
  ...
  return (
    ...
    >
      ...
      {success && (
        <div className="flex items-center gap-2 text-sm text-primary bg-primary/10 rounded-lg p-4">
          <CheckCircle2 className="w-4 h-4" />
          {success}
        </div>
      )}
      ...
      <Card className="bg-card/70 border-border/60">
        ...
        <CardContent className="space-y-6">
          ...
          {filtered.items.map((t) => {
            const idx = data.testimonials.findIndex((x) => x.id === t.id);
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <Input
                    value={t.company}
                    onChange={(e) =>
                      updateTestimonial(idx, "company", e.target.value)
                    }
                    placeholder="Company"
                  />
                </div>
      ...
      <MediaUploadModal
        ...
        onUploaded={(result: MediaUploadResult) => {
          ...
          const imagePath =
            mainVariant?.path ||
            mainVariant?.fileName ||
            data.testimonials[uploadTarget].image;
