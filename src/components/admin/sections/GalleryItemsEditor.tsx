    ...
    <div id="gallery-items" className="pt-6 space-y-4">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground text-sm">
          Create, edit, and organize all gallery entries. These power both the gallery grid and each detail page.
        </p>
                ...
                <CardContent className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <Input
                        value={item.id}
                        onChange={(e) => onItemChange(idx, "id", e.target.value)}
                        placeholder="vr-experience-zone"
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid md:grid-cols-3 gap-3">
                    <div>
                      ...
                      <Input
                        value={item.year}
                        onChange={(e) => onItemChange(idx, "year", e.target.value)}
                        placeholder="2024"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <Input
                      value={item.image}
                      onChange={(e) => onItemChange(idx, "image", e.target.value)}
